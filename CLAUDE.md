...
- **คำบนหน้าจอ (ใช้ให้ตรงกันทุกหน้า รวมข้อความ error จาก server):** สอบถามคะแนน / คำถาม (ไม่ใช้ "ท้วง") · สถานะ รอครูตอบ / ครูตอบแล้ว / เสร็จสิ้น · ผู้ดูแลระบบ / ครู (ไม่ใช้ เจ้าของ, ยศ) · เชื่อมบัญชี Google (ไม่ใช้ ผูก) · ไฟล์ตัวอย่าง (ไม่ใช้ template) · ย้ายออกจากห้อง (ไม่ใช้ เอาออก) · เข้าสู่ระบบ (ไม่ใช้ เซสชัน)
