        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OldValue = table.Column<decimal>(type: "numeric(6,2)", precision: 6, scale: 2, nullable: true),
                    NewValue = table.Column<decimal>(type: "numeric(6,2)", precision: 6, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Terms_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Item_MaxScore", "\"MaxScore\" > 0");
                    table.ForeignKey(
                        name: "FK_Items_Classrooms_ClassroomId",
                        column: x => x.ClassroomId,
                        principalTable: "Classrooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnreadByTeacher = table.Column<bool>(type: "boolean", nullable: false),
                    UnreadByStudent = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scores", x => new { x.ItemId, x.StudentId });
                    table.CheckConstraint("CK_Score_Value", "\"Value\" IS NULL OR \"Value\" >= 0");
                    table.ForeignKey(
                        name: "FK_Scores_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromTeacher = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appeals_UnreadByTeacher",
                table: "Appeals",
                column: "UnreadByTeacher");

            migrationBuilder.CreateIndex(
                name: "IX_Classrooms_TermId_Name",
                table: "Classrooms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Items_ClassroomId_Name",
                table: "Items",
                columns: new[] { "ClassroomId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ScoreAudits_ItemId_StudentId",
                table: "ScoreAudits",
                columns: new[] { "ItemId", "StudentId" });
